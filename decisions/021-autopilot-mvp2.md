...
MVP1: **manual** grid steps + hold-to-repeat only ([ADR 001](001-grid-movement.md)).
...
| MVP1 autopilot | Scope creep; tutorial needs deliberate movement |
...
- [Autopilot (MVP2)](../docs/02-systems/autopilot.md)
