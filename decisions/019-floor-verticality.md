...
7. **Map HUD ([ADR 002](002-mapping-model.md)):** At launch, 2D map shows the **party’s current `level`** slice; other levels when visited (optional layer toggle later).
...
- Launch **content** may ship flat floors first; verticality is **structure-ready** when a floor uses it.
