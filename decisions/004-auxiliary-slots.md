...
4. **Summons** — temporary, no XP, combat-only unless skill specifies otherwise. Sources: **Summoner** deploy skills (MVP1+), post-MVP1 **Protocol Deploy** navigator sortie ([ADR 023](023-protocol-deploy-sortie-summon.md) — Proposed), rare items / boss mechanics.
