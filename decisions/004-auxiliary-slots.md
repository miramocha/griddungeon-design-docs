...
4. **Summons** — temporary, no XP, combat-only unless skill specifies otherwise. Sources: **Summoner** deploy skills (launch)+), later **Protocol Deploy** navigator sortie ([ADR 023](023-protocol-deploy-sortie-summon.md)), rare items / boss mechanics.
