...
9. **Union tuning:** Use draft charge table in [union](../docs/02-systems/synchro-protocol.md) as MVP1 baseline; **one** Navigator (`guild_handler`) + **two** Union skills playable.
