...
8. **Status at launch subset):** Poison, Sleep, Panic, Head Bind, Arm Bind, Offense/Defense Up & Down, Blind, Guard. **DoT can kill.** No leg bind, paralysis, burn, speed mods at launch.
