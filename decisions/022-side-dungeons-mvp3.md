...
6. **Authoring** — reuse floor tile/FOE/encounter data shape from `ExplorationFloor`; MVP3 may add `ExplorationMapKind` or `SideDungeonDefinition` in `ContentDatabase` without changing MVP1 locked IDs.
