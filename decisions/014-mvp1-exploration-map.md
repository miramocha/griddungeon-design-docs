...
3. **Gather nodes (launch):** **One-click instant loot** from node (no minigame). Marks node depleted for dive; full gather **minigame** in **Optional**. Node icon on map when visited.
