...
| **Burst modes** | Transform / blood / rage spikes | **Union bar** + Navigator ([ADR 006](../decisions/006-union-team-bar.md), [007](../decisions/007-navigator-role.md)) — compare feel only |
