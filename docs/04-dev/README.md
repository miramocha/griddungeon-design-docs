...
| [UI camera stack](ui-camera-stack.md) | URP Base + Overlay sandwich for 3D env / UITK backdrop / characters; `UiCameraStackSession`; [ADR 049](../../decisions/049-ui-camera-stack.md) |
