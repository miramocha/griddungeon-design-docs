...
| [UI camera stack](ui-camera-stack.md) | URP layer routing for 3D env / characters + UITK backdrop composite ([#430](https://github.com/miramocha/griddungeon-game/issues/430)); `UiCameraStackSession`; [ADR 049](../../decisions/049-ui-camera-stack.md) |
