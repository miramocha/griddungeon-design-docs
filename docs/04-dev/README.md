...
| [UITK focus chrome](uitk-focus-chrome.md) | Three shared focus variants (filled / invert / transparent), `MenuFocus*.uss`, `--gd-primary` token |
| [Menu primary focus & backdrop UI style](menu-primary-focus-backdrop-style.md) | Frozen `PartyMenuClassBackdrop` as screen UI reference — primary focus, meters, scale table, epic gap audit ([#442](https://github.com/miramocha/griddungeon-game/issues/442)) |
