...
| [Centralized UI gotchas](centralized-ui-gotchas.md) | Implementation traps — pop-in exit races, `IsSettling`, context-switch hide, marker fade vs step motion, detached-host tests |
