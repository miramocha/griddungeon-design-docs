...
- Hub / party menu / story UI 3D sandwich — `UiCameraStackSession` + URP char overlay when backdrop shown ([#428](https://github.com/miramocha/griddungeon-game/issues/428)); UITK backdrop composite ([#430](https://github.com/miramocha/griddungeon-game/issues/430)) — [ADR 049](../decisions/049-ui-camera-stack.md) · [ui-camera-stack](04-dev/ui-camera-stack.md); `PresentationCharacter` tag at spawn for future skill cinematics
