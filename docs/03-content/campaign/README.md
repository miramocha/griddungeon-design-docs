...
**Post-MVP1:** more hub / exploration tile scripts and one-off fights. Game assets stay on existing types (`ExplorationFloor`, `EncounterGroup`, save flags) — see [05 — Class design](../../05-class-design.md#floors--stratum).
