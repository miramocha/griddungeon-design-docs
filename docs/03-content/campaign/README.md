...
**Later:** more hub / exploration tile scripts and one-off fights. Game assets stay on existing types (`ExplorationFloor`, `EncounterGroup`, save flags) — see [content schema](../content-schema.md#content-definitions-runtime-scriptableobjects).
