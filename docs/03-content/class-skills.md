...
**Authority:** Skill IDs and targeting here; implementation types in [05 — class design](../05-class-design.md); SO schema in [content schema](content-schema.md).
...
- [content IDs](content-ids.md#content-ids-locked)
