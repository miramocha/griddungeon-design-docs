...
| FOE combat patrol + mid-battle join | When MVP2+ features ship ([ADR 005](../../decisions/005-foe-combat-patrol.md), [ADR 010](../../decisions/010-chain-foe-battle.md)) |
| Autopilot | Same revealed-tile pathfind when MVP2+ ships ([ADR 021](../../decisions/021-autopilot-mvp2.md)) |
