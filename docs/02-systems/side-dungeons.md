...
Reuse the **ExplorationFloor** tile/FOE shape from [class design — floors](../03-content/content-schema.md#content-definitions-runtime-scriptableobjects); tag content as side via `ExplorationMapKind` or parallel `SideDungeonFloor` SO ([ADR 022](../../decisions/022-side-dungeons-mvp3.md)).
