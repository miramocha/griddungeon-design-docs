...
Paint MVP1 dungeon floors in Unity and export **`ExplorationFloor`** assets. **Authoritative layout:** `Assets/Content/Floors/s1_B*n*F.asset` after Floor Painter **Apply** — not parallel ASCII in design-docs or `S1B*FLayoutBuilder.k_Rows`.
