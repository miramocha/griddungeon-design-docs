...
5. **Elevation:** edit **step units**, **blocky terrain**, seed/min/max, then **Randomize elevation** or **Clear elevation**; **Save** writes `cellElevationSteps`, `elevationStepUnits`, and `useBlockyTerrain` on the floor asset.
