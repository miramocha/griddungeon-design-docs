...
| UI | **`CharacterDetail`** facade / `CharacterDetailView` (sort **251**); floater member bridge `PartyEquipmentFloaterToolkitView`; equip picker `PartyEquipmentPickerFloater` (sort **256**) — [custom party UI](../04-dev/custom-party-ui.md) |
