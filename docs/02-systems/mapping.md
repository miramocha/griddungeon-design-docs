...
**ADR:** [002](../../decisions/002-mapping-model.md), [014](../../decisions/014-mvp1-exploration-map.md)
...
- **Implementation wiring:** [exploration UI](exploration-ui.md) — `ExplorationMapCoordinator` + `MinimapPanelPresenter` / `ExpandedMapOverlayPresenter` (event subscriptions, input, phase visibility).
...
**Open:** Launch ships **toggle-only** (`M`); showing the map **by default** during fights is under evaluation.
