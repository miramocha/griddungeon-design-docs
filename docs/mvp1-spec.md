...
**Status (synced 2026-05-30):** Core explore/combat/save/campaign and S1 floor assets are in. **Combat skill picker shipped** ([#138](https://github.com/miramocha/griddungeon-game/issues/138) / [PR #144](https://github.com/miramocha/griddungeon-game/pull/144)). **Blocking first playable:** [#12](https://github.com/miramocha/griddungeon-game/issues/12) ContentDB · [#52](https://github.com/miramocha/griddungeon-game/issues/52) / [#11](https://github.com/miramocha/griddungeon-game/issues/11) skills · [#31](https://github.com/miramocha/griddungeon-game/issues/31) XP+loot · [#88](https://github.com/miramocha/griddungeon-game/issues/88) guided tutorials · [#15](https://github.com/miramocha/griddungeon-game/issues/15) vertical slice. **Skill epic [#131](https://github.com/miramocha/griddungeon-game/issues/131)** — combat picker done; field **Use skill** ([#140](https://github.com/miramocha/griddungeon-game/issues/140)) + content ([#139](https://github.com/miramocha/griddungeon-game/issues/139)) remain. **Skill trees (hub + floor):** epic [#130](https://github.com/miramocha/griddungeon-game/issues/130) — parallel with [#131](https://github.com/miramocha/griddungeon-game/issues/131); see [§7 skill epics](#skill-system-epics-adr-034--035).
