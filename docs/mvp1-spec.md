...
| **3** | `pull-w03` | [#13](https://github.com/miramocha/griddungeon-game/issues/13) Hub · [#12](https://github.com/miramocha/griddungeon-game/issues/12) ContentDB · [#52](https://github.com/miramocha/griddungeon-game/issues/52) class skill rules | **In progress** — hub done; [#12](https://github.com/miramocha/griddungeon-game/issues/12) · [#52](https://github.com/miramocha/griddungeon-game/issues/52) open (**pull next**) |
