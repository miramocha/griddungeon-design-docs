...
| [ADR 023 — Protocol Deploy sortie summon](decisions/023-protocol-deploy-sortie-summon.md) | Proposed | `protocol_deploy` spawns aux summon; Navigator off-formation |
