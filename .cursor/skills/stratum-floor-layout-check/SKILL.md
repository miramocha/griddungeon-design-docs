...
- Editing `S1B1FLayoutBuilder.k_RowsNorthUp`, S1 ASCII in [archive draft layouts](https://github.com/miramocha/griddungeon-design-docs/blob/main/docs/archive/mvp1-s1-floor-layouts-draft.md), or painted grids in game assets (**layouts not locked**)
