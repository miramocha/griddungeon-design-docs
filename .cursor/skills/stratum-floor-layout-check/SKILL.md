...
description: >-
  Validates Grid Dungeon S1 MVP1 floor assets via Floor Editor validation and
...
1. Edit `Assets/Content/Floors/s1_B*n*F.asset` in **Floor Editor → Apply**.
2. **Floor Editor → Validate** on the grid.
